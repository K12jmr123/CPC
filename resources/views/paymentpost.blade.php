                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              ...
                              <button type="button" class="btn btn-info ms-2" @click="viewRecords({{ $user->id}})"
                                 data-bs-toggle="modal" data-bs-target="#viewModal">view</button>

                              <button type="button" class="btn btn-success ms-2" data-bs-toggle="modal"
                                 data-bs-target="#paypalModal" @click="dosomething({{ $user->id}})">Paynow</button>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form @submit.prevent="paymentsend">
                     <div class="mb-3">
      ...
      <div class="modal fade" id="paypalModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <button type="submit" class="btn btn-primary" @click="originalpaid($event)">Paypal</button>
               ...
               <div class="modal-body">
                  <form>
                     ...
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" v-model="message" readonly>
                     </div>
